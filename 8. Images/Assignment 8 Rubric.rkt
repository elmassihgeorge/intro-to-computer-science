...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Assignment 8 Rubric|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Digital Ready CS001
Assignment 8 - Images
...
|#
(define snowman (above head (scale 1.5 base) (scale 2 base)))
...
as "final-snowman"
|#
(define button (circle 7 "solid" "dark goldenrod"))
(define final-snowman (place-image button 100 200
                                   (place-image button 100 150 snowman)))
...
|#
(define hat (above (rectangle 50 50 "solid" "dark blue") (rectangle 100 20 "solid" "blue")))
(define hat-snowman (above hat final-snowman))